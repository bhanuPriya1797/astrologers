...
class Dives_model extends CI_Model{
    ...
    public function getServiceImageById($id){
        ...
        $this->db->order_by("id", "ASC");
        $query = $this->db->get('tbl_admin_service_image');
        $result   = $query->result();
        return $result;
    }

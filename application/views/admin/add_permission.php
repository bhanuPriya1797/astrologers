        ...
        <form name="saverolepermission" action="" method="post" id="dataForm" novalidate="novalidate">
          ...
          <table class="table text-center" id="dataTable">
            <thead class="bg-white">
              ...
              <input type="hidden" name="view[]" value="1,1" class="checkedViewEditBox" style="margin:3px;">
              <?php
                  ...
                  if($value->id == 1){
                    continue;
              		...
              		<tr>
		                ...
		                <td><label>
		                  <input type="checkbox" name="view[]" value="<?php echo $value->id ;?>,1" class="checkedViewEditBox" style="margin:3px;">
		                  </label>
		                </td>
		                <!-- <td><label>

...
<div class="content-wrapper">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/manage-subadmin/'.$value->id);?>"><i class="fas fa-edit"></i></a>
  ...
  <script>
    ...
    function del(id){
      var result = confirm("Do you want to delete this subadmin ?");
      if (result) {
        $.post('<?=base_url("admin/subadmin/delete_subadmin")?>',
        {
          id : id,
        },
        function(data){

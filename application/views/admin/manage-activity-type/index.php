...
<div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="activity/add"><button class="btn btn-primary" style="float:right;">Add Activity</button></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('admin/activity/'.$value->id);?>"><i class="fas fa-edit"></i></a><a style="color: red;" href="javascript:void(0)" onclick="del('<?php echo $value->id;?>')"><i class="fas fa-trash" style="margin-left:10px;"></i></a></td>
                    </tr>
                    <?php $i++; } ?>
                  </tbody>
                </table>
  ...
  <script>
    ...
    function del(id){
      ...
      if (result) {
        $.post('<?=base_url("admin/activity/delete")?>',
        {
          id : id,
        },
        function(data){
    ...
    $.post('<?=base_url("admin/activity/change_status")?>',
    {
      id : $(this).data('id'),
      email: $(this).val(),

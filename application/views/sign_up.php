...
<head>
    ...
    <title>Lekha-Jokhha Sign Up</title>
            ...
            <div class="row popbox">
                <div class="col-lg-6 col-md-12 col-sm-12 loginbox">
                    <div class="instaastro">
                        <img src="<?php echo base_url('assets/img/lekha_logo_new.png'); ?>" alt="lekha-jokhha-Logo">
                        <h5 class="modal-heading">Sign Up</h5>
                        <p class="box-text-content">Enter your mobile number to Sign Up</p>
        ...
        <div class="model-body">
            <div class="form-wrapper">
                <p class="text-center otpinfo">Enter 6 digit OTP sent to your phone <strong><?php echo $_SESSION['mobile']; ?></strong>
                    <a href="<?php echo base_url('signup');?>">Change</a>
                </p>

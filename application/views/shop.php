							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_kd_right_first_sec_wrapper2">
									...
									<div class="hs_kd_right_first_sec_img_heading">
										<img src="<?php echo base_url('assets/images/content/kundali/patrika3.jpg');?>" alt="patrika" />
									</div>
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								<div class="hs_shop_tabs_sec_wrapper">
									...
									<ul class="list-inline nav nav-pills">
										<li class="active"><a data-toggle="pill" href="#home"><i
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="hs_shop_tabs_cont_sec_wrapper">
								<div class="tab-content">
									<?php foreach ($productList as $key => $provalue) { ?>
									<div id="home" class="tab-pane fade in active">
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="hs_shop_prodt_main_box">
													<div class="hs_shop_prodt_img_wrapper">
														<img src="<?php echo base_url('assets/uploads/product_image/');?><?php echo $provalue->product_image; ?>" alt="shop_product">
													</div>
													<div class="hs_shop_prodt_img_cont_wrapper">
														...
														<i class="fa fa-star-o"></i>
														<h2><a href="<?php echo base_url('shope/shop/'); ?><?php echo $provalue->product_slug; ?>"><?php echo $provalue->product_name; ?></a></h2>
														<h3><del><?php echo $provalue->product_price; ?></del>&nbsp; <?php echo $provalue->product_price; ?></h3>
									...
									<div id="menu1" class="tab-pane fade">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="hs_shop_prodt_main_box">
													<div class="hs_shop_prodt_list_img_wrapper">
														<img src="images/content/shop/sp1.jpg" alt="shop_product">
													</div>
													<div class="hs_shop_prodt_list_cont_wrapper">
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star-o"></i>

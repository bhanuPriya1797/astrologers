                                                ...
                                                <div class="row form-content">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name"> Name <span
                                                                    class="astrick-color">*</span></label>
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter First Name" name="name"
                                                                id="first-name" value="<?php echo $profileData->name;?>" required >
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-lg-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name">Birth Place <span
                                                                    class="astrick-color">*</span></label>
                                                            
                                                                <input type="text" class="form-control" placeholder="Place of Birth" name="place_of_birth" value="<?php echo $profileData->place_of_birth;?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name">Date Of Birth <span 
                                                            class="astrick-color">*</span></label>
                                                            
                                                            <input type="text" placeholder="Day" class="form-control" name="date_of_birth" id="dob" value="<?php echo $profileData->date_of_birth;?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name">Time Of Birth <span 
                                                            class="astrick-color">*</span></label>
                                                            <input type="time" class="form-control" placeholder="Time Of Birth" 
                                                            name="time-of-birth"  value="<?php echo $profileData->time_of_birth;?>" id="time-of-birth" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name">Marital Status <span 
                                                            class="astrick-color">*</span></label>
                                                            <select name="marital_status">
                                                                <option value="">Marital Status</option>
                                                                <option value="single" <?php if($profileData->marital_status == 'single'){echo "selected"; }?>>Single</option>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            <label class="name">Occupation <span 
                                                            class="astrick-color">*</span></label>
                                                            <select name="occupation">
                                                                <option value="">Occupation</option>
                                                                <option value="student" <?php if($profileData->occupation == 'student'){echo "selected"; }?>>Student</option>
                                                    ...
                                                    <div class="form-group mt-4 col-12 d-flex">
                                                         <button type="submit" class="bluesub-btn">Submit</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>  

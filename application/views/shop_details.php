...
<head>
	<meta charset="utf-8" />
	<title><?php echo $productDetails->product_name; ?></title>
			...
			<div class="row">
						...
						<div class="cc_ps_top_slider_section">
							<div class="owl-carousel owl-theme">
								<div class="item" data-hash="zero">
									...
									<img class="small img-responsive" src="<?php echo base_url('assets/uploads/product_image/'); ?><?php echo $productDetails->product_image; ?>"
										alt="small_img" />
										...
										<div class="row">
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 cc_ps_tabs">
												<a class="button secondary url owl_nav" href="#zero"><img
														src="<?php echo base_url('assets/uploads/product_image/'); ?><?php echo $productDetails->product_image; ?>" class="img-responsive"
														alt="nav_img"></a>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 cc_ps_tabs">
												<a class="button secondary url owl_nav" href="#one"><img
														src="<?php echo base_url('assets/uploads/product_image/'); ?><?php echo $productDetails->product_image; ?>" class="img-responsive"
														alt="nav_img"></a>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 cc_ps_tabs">
												<a class="button secondary url owl_nav" href="#two"><img
														src="<?php echo base_url('assets/uploads/product_image/'); ?><?php echo $productDetails->product_image; ?>" class="img-responsive"
														alt="nav_img"></a>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 cc_ps_tabs">
												<a class="button secondary url owl_nav" href="#three"><img
														src="<?php echo base_url('assets/uploads/product_image/'); ?><?php echo $productDetails->product_image; ?>" class="img-responsive"
														alt="nav_img"></a>
											</div>
										</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="hs_shop_single_border_Wrapper">
						<div class="hs_shop_single_review_wrapper">
							...
							<ul>
								...
								<li class="hidden-xs"><a href="#">Add Your Review</a></li>
							</ul>
						</div>
						<div class="hs_shop_single_right_heading_wrapper">
							<h2><?php echo $productDetails->product_name; ?></h2>
						</div>
						<div class="hs_shop_single_price_wrapper">
							<h4><?php echo $productDetails->product_price; ?></h4>
							<del><?php echo $productDetails->product_price; ?></del>
							<ul>
								<li>35% off</li>
							</ul>
						</div>
						<div class="hs_shop_single_stock_wrapper">
							<ul>
								<li>Available : <span><i class="fa fa-check-circle"></i> In Stock</span></li>
								<li>Product ID : <span>#201546</span></li>
							</ul>
						</div>
					</div>
					<div class="hs_shop_single_cont_wrapper">
					<?php echo $productDetails->product_description; ?>
						<span class="hs_shop_single_heading">Color</span>
						<ul class="hs_shop_single_list hs_shop_single_list_color">
							<li>
								<a title="Check" href="#" class="color1">
									<i class="fa fa-check"></i>
								</a>
							</li>
							<li>
								<a title="Check" href="#" class="color2 active">
									<i class="fa fa-check"></i>
								</a>
							</li>
							<li>
								<a title="Check" href="#" class="color3">
									<i class="fa fa-check"></i>
								</a>
							</li>
							<li>
								<a title="Check" href="#" class="color4">
									<i class="fa fa-check"></i>
								</a>
							</li>
						</ul>
					</div>
					<div class="hs_shop_single_cart_btn_wrapper">
						<div class="hs_shop_single_cart_btn hs_btn_wrapper">
							...
							<ul>
								...
								<li>
									<a href="#" class="hs_btn_hover" title="Add to Cart">
								...
								<li>
									<a href="#" class="compare" title="Add to Compare">
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="product_tab_1">
								<div class="tab_content_text">
									<p>A gemstone (also called a gem, fine gem, jewel, precious stone, or semi-precious
										stone) is a piece of mineral crystal which is in cut and polished form, it is
										used to make jewelry.</p>
									<ul class="tab_list_item">
										<li>Easily Comfortable</li>
										<li>Category: Sports Wear</li>
										<li>Tags: Sports Wear, Clothing, T-Shirts
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="hs_client_img_wrapper">
								<img src="images/content/logo01.png" alt="client_img" />
							</div>
						</div>
						<div class="item">
							<div class="hs_client_img_wrapper">
								<img src="images/content/logo02.png" alt="client_img" />
							</div>
						</div>
						<div class="item">
							<div class="hs_client_img_wrapper">
								<img src="images/content/logo03.png" alt="client_img" />
							</div>
						</div>
						<div class="item">
							<div class="hs_client_img_wrapper">
								<img src="images/content/logo04.png" alt="client_img" />
							</div>
						</div>
					</div>
				</div>

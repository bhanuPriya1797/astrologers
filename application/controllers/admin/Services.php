...
class All_dives extends Core_Admin_Controller {
    ...
    public function add_dives() {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            if ($this->form_validation->run() != false) {
                ...
                redirect('admin/all-manage-dives'); 
            }
            else{
    ...
    public function edit_dives() {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            if ($this->form_validation->run() != false) {
                ...
                redirect('admin/manage-all-dives'); 
            }
            else{
                $this->session->set_flashdata('error', validation_errors());
            }
    ...
    public function delete_dives() {
        ...
        $this->data['vendors'] = $this->Common_model->delete('tbl_vendor_dives_location',['id'=> $this->input->post('id')]);
        echo "success";
    }
    ...
    {
        $this->PermissionModel->Update($this->input->post('id'),['status' => $this->input->post('status')],'tbl_vendor_dives_location');
        echo "success";

...
document.getElementById('btn-modal').onclick = function () {
    document.getElementById('cnt-modal').style.display = "block";
}

window.onclick = function (event) {
    if (event.target == document.getElementById('w')) {
        document.getElementById('cnt-modal').style.display = "none";
    }
}


// tab
function openTab(evt, req) {
...
// 
var mID = document.getElementById("closebtn");
mID.addEventListener("click", function () {
    var x = document.getElementById("cnt-modal");
